 ...
 *
 *  In javascript, we are linking the child class or entity to the parent
 *  using `prototype`. when we create the object it does not copy the properties
 *  or behavior, it creates a link.
 *
 ...
 *
 * - using new keyword on function
 * - function constructor takes arguemtns while instantiating new object
 *
 * ******************************************************************
 */
